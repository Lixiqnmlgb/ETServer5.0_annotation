			...
			{	
				...
				switch (startConfig.AppType)
				{
					case AppType.Manager:
						Game.Scene.AddComponent<AppManagerComponent>();//应用管理器 用于启动其他的进程
						Game.Scene.AddComponent<NetInnerComponent, string>(innerConfig.Address);//内网组件 用于进程之间的通信
						Game.Scene.AddComponent<NetOuterComponent, string>(outerConfig.Address);
						break;
					case AppType.Realm:
						Game.Scene.AddComponent<MailboxDispatcherComponent>();//缓存与调用 加了MailboxHandlerAttribute特性的实例
						Game.Scene.AddComponent<ActorMessageDispatcherComponent>();//缓存所有处理Actor消息的实例
						Game.Scene.AddComponent<NetInnerComponent, string>(innerConfig.Address);//内网组件 用于进程之间的通信
						Game.Scene.AddComponent<NetOuterComponent, string>(outerConfig.Address);
